...
# def Films(request):
#     posts = Post.objects.filter(type='film').order_by('-date')
#     aside = Post.objects.all().order_by('?')[:10]
#     genres = Genre.objects.all()
#     pubs = Pub.objects.all()
#     context = {
...
# def Series(request):
#     posts = Post.objects.filter(type='serie').order_by('-date')
#     aside = Post.objects.all().order_by('?')[:10]
#     genres = Genre.objects.all()
#     pubs = Pub.objects.all()
#     context = {
...
#     posts = Post.objects.filter(type='documentaire').order_by('-date')
#     aside = Post.objects.all().order_by('?')[:10]
#     genres = Genre.objects.all()
#     pubs = Pub.objects.all()
#     context = {
...
#     posts = Post.objects.filter(type='emission').order_by('-date')
#     aside = Post.objects.all().order_by('?')[:10]
#     genres = Genre.objects.all()
#     pubs = Pub.objects.all()
#     context = {
...
#     posts = Post.objects.filter(type='télé réalité').order_by('-date')
#     aside = Post.objects.all().order_by('?')[:10]
#     genres = Genre.objects.all()
#     pubs = Pub.objects.all()
#     context = {
...
#     else:
#         form = CommentForm()
#     return render(request, template_name, {'post': post, 'form': form, 'comments': comments, 'genres': genres,'aside': aside})
